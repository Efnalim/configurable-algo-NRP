...
class HistorySimulator:
    ...
    def update_history_for_next_week(self, results, constants, week_number):
        ...
        working_days, shifts = self._compute_helpful_values(results, constants, week_number)

        self._update_border_data(constants, working_days, shifts)
        self._update_cumulative_data(constants, working_days, shifts)
        # print(history_data["nurseHistory"])

    def _update_border_data(self, constants, working_days, shifts):
    ...
    def _update_cumulative_data(self, constants, working_days, shifts):
        for n in range(constants["num_nurses"]):
    ...
    def _compute_helpful_values(self, results, constants, week_number):
